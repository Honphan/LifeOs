...
export function LoginPage() {
  ...
  return (
    <>
      {/* Heading */}
      <h1 className="font-display text-h1 text-primary mb-2">Welcome back</h1>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="flex justify-end">
          <a href="#" className="text-sm text-secondary hover:text-tertiary transition-base font-body">
            Forgot password?
          </a>
        </div>
      ...
      <p className="text-center mt-6 text-sm text-primary/50 font-body">
        ...
        <Link to="/register" className="text-secondary hover:text-tertiary transition-base font-medium">
          Create account
        </Link>
      </p>
    </>
